...
const ViewFord = () => {
    ...
    const hourlyRate = 450000; // Hourly rate in PKR
                ...
                <div className="row" >
                    ...
                    <div className="col-lg-4" >
                        ...
                        <div className="card"style={{width:'300px', height: '400px', marginLeft: '-250px'}}>
                            <img src="../../../images/fordGt.jpg" className="card-img-top" alt="Car Image" />
                            <div className="card-body">
                                <h5 className="card-title">Ford-Gt</h5>
                                <p className="card-text" style={{ fontStyle: 'italic' }}>20,000 pkr</p>
                                <p className="card-info">Mileage: 90,000 km<br/>Year: 2023<br/>Location: Peshawar</p>
