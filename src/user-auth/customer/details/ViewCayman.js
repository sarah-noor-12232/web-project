...
const ViewCayman = () => {
    ...
    const hourlyRate = 45000; // Hourly rate in PKR
                ...
                <div className="row" >
                    ...
                    <div className="col-lg-4" >
                        ...
                        <div className="card"style={{width:'300px', height: '400px', marginLeft: '-250px'}}>
                            <img src="../../../images/cayman.jpg" className="card-img-top" alt="Car Image" />
                            <div className="card-body">
                                <h5 className="card-title">Porsche Cayman</h5>
                                <p className="card-text" style={{ fontStyle: 'italic' }}>20,000 pkr</p>
                                <p className="card-info">Mileage: 90,000 km<br/>Year: 2018<br/>Location: Peshawar</p>
