...
const ViewCayenne = () => {
    ...
    const hourlyRate = 20000; // Hourly rate in PKR
                ...
                <div className="row">
                        ...
                        <div className="card" style={{ width: '300px', height: '400px' }}>
                            ...
                            <div className="card-body">
                                ...
                                <div className="rating">
                                    ...
                                    {[...Array(5 - carDetails.rating).keys()].map((_, i) => (
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="card" style={{ width: '800px' }}>
                            ...
                            <Link to="/user-auth/customer/details/Checkout" className="btn btn-primary" style={{ margin: '20px' }}>Pay</Link>
                        </div>
                    </div>
                </div>
            </div>
