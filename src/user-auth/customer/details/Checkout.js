  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h1 style={{ color: 'white', fontWeight: 'bold', textAlign: 'center' }}>Checkout</h1>
        <div className="d-lg-flex justify-content-center">
          <div className="box" style={{backgroundColor: 'white', padding:'10px', borderRadius:'10px', marginBottom:'20px'}}>
            <div className="box-inner-2">
              ...
              <form>
                <div className="mb-3">
                  ...
                  <input className="form-control" type="email" defaultValue="buyer@urbandrive.com" />
                </div>
                <div>
                  ...
                  <div className="d-flex align-items-center justify-content-between card-atm border rounded">
                    <div className="fab fa-cc-visa ps-3" style={{width:'60px', padding:'5px'}}>
                  ...
                  <div className="address">
                    ...
                    <div className="my-3">
                      ...
                      <div className="inputWithcheck">
                        <input className="form-control" type="text" defaultValue="GB012345B9" />
                    ...
                    <div className="d-flex flex-column dis">
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <p>Subtotal</p>
                        <p><span className="fas fa-dollar-sign"></span>PKR 50000.00</p>
                      </div>
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <p>VAT<span>(2.5%)</span></p>
                        <p><span className="fas fa-dollar-sign"></span>PKR 1250.00</p>
                      </div>
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <p className="fw-bold">Total</p>
                        <p className="fw-bold"><span className="fas fa-dollar-sign"></span>PKR 51250.00</p>
                      </div>
                      <button className="btn btn-primary mt-2">Pay<span className="fas fa-dollar-sign px-1"></span>PKR 51250.0</button>
                    </div>
                  </div>
                </div>
              </form>
