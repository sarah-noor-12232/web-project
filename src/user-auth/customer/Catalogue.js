  ...
  const cars = [
    {
      ...
      rating: 2,
      link: "/user-auth/customer/details/ViewCayenne"
    },
    {
      id: 'cayman',
      name: 'Porsche Cayman',
      ...
      rating: 3,
      link: "/user-auth/customer/details/ViewCayman"
    },
    {
      id: 'ferrariF40',
      name: 'Ferrari F40',
    ...
    },
    {
      ...
      year: '2023',
      location: 'Islamabad / Rawalpindi',
      image: '../../images/fordGt.avif', 
      rating: 4,
      link: "/user-auth/customer/details/ViewFord"
    },
    {
      id: 'mehranVXR',
      name: 'Mehran VXR',
      ...
      year: '2014',
      location: 'Karachi',
      image: '../../images/mehru.jpg', 
      rating: 1,
      link: "/user-auth/customer/details/ViewMehran"
    },
    {
      id: 'porsche911',
      name: 'Porsche 911',
      ...
      rating: 3,
      link: "/user-auth/customer/details/ViewPorsche"
    }
  ];
  

  const [image, setImage] = useState(cars.link);

  const filteredCars = cars.filter(car =>
    car.name.toLowerCase().includes(search) &&
    (selectedLocation === 'Choose Location' || car.location === selectedLocation)
  );
  const renderStars = (rating) => {
    return (
      <>
        {Array.from({ length: rating }, (_, i) => (
          <FontAwesomeIcon key={i} icon={solidStar} className="checked" />
        ))}
        {Array.from({ length: 5 - rating }, (_, i) => (
          <FontAwesomeIcon key={i} icon={regularStar} className="unchecked" />
        ))}
      </>
    );
  };
