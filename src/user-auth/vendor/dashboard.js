...
const Dashboard = () => {
    const cars = [
        {
            image: `${process.env.PUBLIC_URL}/images/cayenne.jpg`, 
            ...
            location: 'Karachi',
            rating: 2,
            link: "/user-auth/vendor/dashboard-cars/cayenne"
        },
        {
            image: `${process.env.PUBLIC_URL}/images/cayman.jpg`,
        ...
        {
            image: `${process.env.PUBLIC_URL}/images/porsche911.jpg`,
            title: 'Porsche 911',
            price: '900,000 pkr',
            mileage: '50,000 km',
            year: '2018',
        ...
        return (
            <>
                {[...Array(rating)].map((_, index) => (
                    <FontAwesomeIcon key={index} icon={faStarSolid} className="checked" />
                ))}
                {[...Array(5 - rating)].map((_, index) => (
                    <FontAwesomeIcon key={index} icon={faStarRegular} className="unchecked" />
                ))}
            </>
        );
    };
                        ...
                        <div key={index} className="col-md-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text" style={{ fontStyle: 'italic' }}>{car.price}</p>
                                    <p className="card-info">Mileage: {car.mileage}<br />Year: {car.year}<br />Location: {car.location}</p>
