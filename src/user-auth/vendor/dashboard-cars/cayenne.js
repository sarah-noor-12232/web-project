...
import carImage from '../../../images/cayenne.jpg';
import './cat-style.css'



const ViewCayenneVendor = () => {
    const [carLogs, setCarLogs] = useState([
        { rentalId: '1001', renterId: '2001', startDate: '2024-03-01 09:00', endDate: '2024-03-01 12:00', duration: '3', totalCost: '$60', status: 'Completed' },
        { rentalId: '1002', renterId: '2002', startDate: '2024-03-02 14:00', endDate: '2024-03-03 10:00', duration: '20', totalCost: '$400', status: 'Completed' },
        { rentalId: '1003', renterId: '2003', startDate: '2024-03-04 08:00', endDate: '2024-03-05 08:00', duration: '24', totalCost: '$480', status: 'Ongoing' },
        { rentalId: '1004', renterId: '2004', startDate: '2024-03-05 15:00', endDate: '2024-03-05 18:00', duration: '3', totalCost: '$60', status: 'Canceled' }
      ]);
  return (
    <>
      ...
      <div className="row" style={{width:'1000px'}}>
        <div className="col-lg-4">
          ...
          <div className="card" style={{height:'500px'}}>
            <img src="/images/cayenne.jpg" className="card-img-top" alt="Car Image" />
            <div className="card-body">
              <h5 className="card-title">Porsche Cayenne</h5>
              <p className="card-text" style={{ fontStyle: 'italic' }}>20,000 pkr</p>
              <p className="card-info">Mileage: 50,000 km<br />Year: 2018<br />Location: New York</p>
              ...
              <a href="./edit-cayenne" className="back-button" style={{ width: '100px', marginTop: '40%' }}>Edit</a>
            </div>
          </div>
        </div>
        <div className="col-lg-8">
          <div className="card" style={{width:'800px'}}>
            ...
            <a href="../dashboard" className="back-button" style={{ width: '180px', marginLeft: '75%' }}>Go Back</a>
          </div>
        </div>
      </div>
    </div>
...
export default ViewCayenneVendor;
