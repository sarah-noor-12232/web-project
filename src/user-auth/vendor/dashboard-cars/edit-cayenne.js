  ...
  return (
    <>
      ...
      <div className="row" style={{width:'1000px'}}>
        ...
        <div className="col-lg-8" style={{marginLeft: '0px'}}>
            <div className="container" style={{marginLeft:'30px'}}>
                <h1 style={{color: 'white'}}>EDIT CAR DETAILS</h1>
                <div className="form-area">
                    <div className="form-container">
                        <form>
                            <div className="form-group">
                                <label className="sub-title">Car Make</label>
                                <input
                                    name="make"
                            ...
                            <div className="form-group">
                                <label className="sub-title">Year</label>
                                <input
                                    name="year"
                                    className="form-style"
                                    type="number"
                            ...
                            <div className="form-group">
                                <label className="sub-title">Mileage</label>
                                <input
                                    name="mileage"
                                    className="form-style"
                                    type="number"
                            ...
                            <div className="form-group">
                                <label className="sub-title">PKR/hr</label>
                                <input
                                    name="price"
                                    className="form-style"
                                    type="number"
                  ...
                  <div className="upload-container">
                    ...
                    <Link to="/user-auth/vendor/dashboard" className="btn btn-primary">Complete</Link>
                  </div>
